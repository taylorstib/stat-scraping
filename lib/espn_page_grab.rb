...
# class Scraper
#   def scrape(position)
#     STDERR.puts "You asked for the #{position} stats\nHere they come."
#     arr = []
...
#     STDERR.puts "#{num_pages - 1} more pages need to be collected"
...
#           STDERR.puts "File #{position}#{x} saved successfully"
#       end
#     end
#     STDERR.puts "Reached the end of the 'scrape #{position}' method"
